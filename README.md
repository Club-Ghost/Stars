[index.html](https://github.com/user-attachments/files/28284413/index.html)
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="player-container">
        ...
        <div class="player-card">
            ...
            <div class="card-head">
                <div class="avatar-box">
                    <img src="https://live.staticflickr.com/65535/55295669124_c2514f1099.jpg"玩家头像">
                </div>
                <div class="player-info">
                    <h2>顾思远</h2>
                    <span class="player-tag"> 世界|第一帅</span>
                </div>
            </div>
            <div class="player-desc">
                <p>顾思远,化名（小帅）绰号：无.大家好，我叫顾思远，旁人常评价我模样精神，气质洒脱，我性格直爽大方，不拘小节，很好相处，平日里热爱运动，也喜欢静下心来看看书，我待人友善，懂得尊重他人，珍惜身边的每份情谊，很荣幸认识各位，期待接下来的朝夕相伴，也希望能和大家成为要好的朋友，一起度过轻松美好的时光.</p>
            </div>
        ...
        <div class="player-card">
            ...
            <div class="card-head">
                <div class="avatar-box">
                    <img src="https://live.staticflickr.com/65535/55294433062_3d729b2581_z.jpg"玩家头像">
                </div>
                <div class="player-info">
                    <h2>刘笑天</h2>
        ...
        <div class="player-card">
            ...
            <div class="card-head">
                <div class="avatar-box">
                    <img src="https://live.staticflickr.com/65535/55294433967_8fa4cb6ff1_z.jpg"玩家头像">
                </div>
                <div class="player-info">
                    <h2>杨佳旭</h2>
        ...
        <div class="player-card">
            ...
            <div class="card-head">
                <div class="avatar-box">
                    <img src="https://live.staticflickr.com/65535/55295579538_cc995f7dc5_z.jpg"玩家头像">
                </div>
                <div class="player-info">
                    <h2>张嘉轩</h2>
     ...
     <!-- 玩家卡片 8-->
        <div class="player-card">
            ...
            <div class="card-head">
                <div class="avatar-box">
                    <img src="https://live.staticflickr.com/65535/55295919625_787cfe08a1_z.jpg"玩家头像">
                </div>
                <div class="player-info">
                    <h2>顾涵旭</h2>
      ...
      <!-- 玩家卡片 9-->
        <div class="player-card">
            ...
            <div class="card-head">
                <div class="avatar-box">
                    <img src="https://live.staticflickr.com/65535/55295684563_70cc7929f2.jpg"玩家头像">
                </div>
                <div class="player-info">
                    <h2>顾天伦</h2>
